    ...
    setup() {
      ...
      async function goToPage(page) {
        if (page >= 1 && page <= totalPages.value && page !== currentPage) {
          ...
          const authorValue = searchParams.value.author ? searchParams.value.author.target._value : "";
          const searchValue = searchParams.value.search ? searchParams.value.search.target._value : "";
