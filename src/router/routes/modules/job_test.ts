...
const comp: AppRouteModule = {
  ...
  name: 'JobTest',
  component: LAYOUT,
  redirect: '/job_test/basic',
  meta: {
    orderNo: 11,
    icon: 'ion:layers-outline',
    title: t('routes.job_test.job_test.job_test'),
  },

  children: [
    {
      path: 'job_test_manage',
      name: 'JobTestManage',
      component: () => import('/@/views/job_test/job_test_manage/basic.vue'),
      meta: {
        title: t('routes.job_test.job_test.job_test_manage'),
      },
    },
    {
      path: 'test',
